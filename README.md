...
This repository houses the terraform module for provisioning Google Kubernetes Engine clusters. 

Releases are provided by `release-please` using Github Actions.
...
```hcl
module "gke" {
source                  = "git::https://github.com/cvs-health-source-code/terraform-gke?ref=main"
project_id             = "digital-dfp-dev"
project_number         = 906706276027
env-type               = "nprod"
cluster_name           = "digital-dfp-lynx"
region                 = "us-east4"
description            = "creating new cluster with cloudbuild"
master_ipv4_cidr_block = "10.143.224.128/28"
network_project_id     = "vpc-equinix-cvs"
network                = "vpc-cvs-hub-nonprod-1"
subnetwork             = "sn-cvs-us-east4-digital-dev-dfp-nodes"
ip_range_pods          = "sn-cvs-us-east4-digital-dev-dfp-nodes-pods"
ip_range_services      = "sn-cvs-us-east4-digital-dev-dfp-nodes-svcs"

cluster_resource_labels = {
  "gke-cluster" : "digital-dfp-lynx-custom-label"
}


master_authorized_networks = [
  {
    cidr_block   = "10.143.224.64/26",
...
node_pools_labels = {
  ...
  all = {
    "gke-node-pool" : "digital-dfp-lynx"
  }
...
## Terraform Provider block below, don't edit the below section.
terraform {
  ...
  provider_meta "google" {
    module_name = "blueprints/terraform/terraform-google-kubernetes-engine:private-cluster/v28.0.0"
  }
}
```
...
### Auto PR Approve and Merge

To automate the PR approval process for publishing releases. Goal is to save time and avoid rework for engineers

1. Auto-merge the pull-request that gets generated when committing to main branch
